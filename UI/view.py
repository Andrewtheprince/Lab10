...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._ddStati = ft.Dropdown(label="Stato", width=300, disabled=True)
        self._controller.fillDD()
        self._btnStatiRaggiungibili = ft.ElevatedButton(text="Stati Raggiungibili",on_click=self._controller.handleStatiRaggiungibili, width=200, disabled=True)
        row2 = ft.Row([self._ddStati, self._btnStatiRaggiungibili], alignment=ft.MainAxisAlignment.CENTER)
